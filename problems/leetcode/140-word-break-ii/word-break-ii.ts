// Time complexity: O(n^3 * d + a), where n is s.length, d is wordDict.length, and a is the total size of all returned sentences
// Space complexity: O(n + a), for the recursion stack, cache, and generated sentences
